      ...
      if(flag==0)
        for i=2:2:50 
            if(k==14)
                ...
                finerrd4=mean(error4);
                finalerror=mean(finerrd1+finerrd2+finerrd3+finerrd4);
                  return
            end 
